...
import { buildApiUrl, buildTenantApiUrl } from "../lib/api";
...
const handleGuestSubmit = async () => {
  ...
  const handleLogin = async (
    ...
    try {
      ...
      const loginUrls = [
        buildApiUrl("/api/employees/login"),
        buildTenantApiUrl(normalizedCompanyCode, "/api/employees/login"),
      ];
      ...
      for (const loginUrl of loginUrls) {
        try {
          ...
          // Try next URL before failing login.
        }
      }
